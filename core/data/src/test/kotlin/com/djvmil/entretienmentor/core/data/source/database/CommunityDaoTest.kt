...
class CommunityDaoTest {
    ...
    fun test_insert_select_community_in_db() = runTest{
        ...
        //THEN
        communityActual.test {
            Truth.assertThat(awaitItem()).isEqualTo(communityExpected.copy(id = 1))
        }
    ...
    fun test_insert_all_select_all_community_in_db() = runTest{
        // GIVEN
        val communitiesExpected = listOf(
        ...
        //THEN
        communitiesActual.test {
            Truth.assertThat(awaitItem()).isEqualTo(communitiesExpected)
        }
    ...
    fun test_update_community_in_db() = runTest{
        ...
        val communityUpdated = communityInsert.copy(
            name = FAKE_DATA.fakeCommunityData.name.plus(" Updated")
        )
        ...
        //THEN
        communityActual.test {
            Truth.assertThat(awaitItem()).isEqualTo(communityUpdated)
        }
    ...
    fun test_delete_community_in_db() = runTest{
        ...
        communityActual.test {
            Truth.assertThat(awaitItem()).isEqualTo(communityInsert)
        }
