 ...
 */
@Stable
class Teleport(private val animationSpec: AnimationSpec<Float> = spring()) : BallAnimation {
  ...
  override fun animateAsState(
    ...
    return produceState(initialValue = BallAnimInfo(), key1 = fraction.value) {
      this.value =
          this.value.copy(
