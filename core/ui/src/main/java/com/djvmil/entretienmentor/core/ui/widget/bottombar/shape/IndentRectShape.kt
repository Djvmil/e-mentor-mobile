...
class IndentRectShape(
  ...
  override fun createOutline(
      ...
      Outline.Generic(Path().addRoundRectWithIndent(size, indentShapeData, layoutDirection))
  ...
  return apply {
    ...
    arcTo(
        rect =
            Rect(
                offset =
                    Offset(width - cornerRadius.bottomRight, height - cornerRadius.bottomRight),
    ...
    arcTo(
        rect =
            Rect(offset = Offset(0f, 0f), size = Size(cornerRadius.topLeft, cornerRadius.topLeft)),
